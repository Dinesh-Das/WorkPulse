        ...
        {sortedActivities.length === 0 ? (
          ...
          <div className="space-y-1">
            {sortedActivities.map((activity) => (
              ...
              >
                <div className="mt-0.5 w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center flex-shrink-0 group-hover:bg-white transition-colors border border-transparent group-hover:border-gray-100">
